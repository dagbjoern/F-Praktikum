...
plt.ylabel(r'Spannung $U/ \si{\milli\volt} $')
plt.tight_layout()
...
plt.figure(8)
plt.errorbar(delta_B, 1000*noms(Abstande),xerr=0,yerr=1000*stds(Abstande),LineStyle='none',label=r'Messwerte')
plt.plot(delta_B, 1000*gerade(delta_B,*params_lin),label=r'Fit-Funktion')
...
plt.ylabel(r'$\bar{s} / \si{\milli\meter}$')
plt.tight_layout()
